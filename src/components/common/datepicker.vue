<template>
    <div class="datePicker">
        ...
        <date-popup-picker :show="showPopup" :minPrice="minPrice" :isOneWay="isOneWay" :endLocal="arriveCityCode"
            :startLocal="departCityCode" :currDate="currDate" @close-date-picker="closeDatePicker" @go-back="goBack">
        </date-popup-picker>
    </div>
</template>
...
import { getDayCountOfMonth, getMonth, getDay, getYear, getWeekend, formatMonth, formatNum } from '../../utils/utils.js';
...
export default {
    ...
    methods: {
        ...
        chooseDate(val, index) {
            ...
            this.$emit('chosed-flight-list', val)
        },
        showDatePickerPopup() {
            this.showPopup = true
        },
    ...
    watch: {
        minPrice(val) {
            if(this.currentDate.TicketPrice === 0) {
                this.dateInfo.originDate[this.currentIndex].TicketPrice = val
